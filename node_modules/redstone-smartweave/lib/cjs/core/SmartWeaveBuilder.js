...
class SmartWeaveBuilder {
    ...
    useRedStoneGateway(confirmationStatus = null, source = null) {
        this._interactionsLoader = new _smartweave_1.RedstoneGatewayInteractionsLoader('https://gateway.redstone.finance', confirmationStatus, source);
        this._definitionLoader = new _smartweave_1.RedstoneGatewayContractDefinitionLoader('https://gateway.redstone.finance', this._arweave, new _smartweave_1.MemCache());
        return this;
    }
    build() {
