...
class DefaultCreateContract {
    ...
    async deploy(contractData, wasmSrcCodeDir, wasmGlueCodePath) {
        ...
        if (contractType == 'wasm') {
            ...
            if (wasmLang == 'rust') {
                ...
                const wasmBindgenSrc = fs_1.default.readFileSync(wasmGlueCodePath, 'utf-8');
        ...
        if (response.status === 200 || response.status === 208) {
            ...
            throw new Error(`Unable to write Contract Source: ${response === null || response === void 0 ? void 0 : response.statusText}`);
        }
    }
    async deployFromSourceTx(contractData) {
        ...
        contractTX.addTag(core_1.SmartWeaveTags.CONTRACT_TYPE, contractData.contractType);
        if (contractData.contractType == 'wasm') {
            contractTX.addTag(core_1.SmartWeaveTags.WASM_LANG, contractData.wasmLang);
        }
