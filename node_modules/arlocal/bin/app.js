...
class ArLocal {
    constructor(port = 1984, showLogs = true, dbPath, persist = false, fails = 0) {
        ...
        this.fails = fails;
        this.log = new logging_1.default(showLogs);
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.router.get('/price/:bytes/:addy?', (ctx) => __awaiter(this, void 0, void 0, function* () { return (ctx.body = +ctx.params.bytes * 1965132); }));
            ...
            this.router.post('/tx', transaction_1.txPostRoute);
